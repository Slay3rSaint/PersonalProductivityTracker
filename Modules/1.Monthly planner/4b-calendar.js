  ...
  draw : () => {
    ...
    if (cal.events !== false) { for (let [id,evt] of Object.entries(cal.events)) {
      ...
      for (let [r,c] of Object.entries(cell)) {
        ...
        rowB.style.height = "40px"; // set height
        rowB.style.fontSize = "14pt"; // set font size
        rowB.style.textAlign = "center";
        rowB.style.paddingTop = "5px";
        rowB.style.borderRadius = "18px";
