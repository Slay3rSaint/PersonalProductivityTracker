...
<body>
  <div id="wrapper">
    <!-- <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0; color:#FF0">
          ...
          dddddddddd -->
    <!-- <div style="color: white;padding: 15px 50px 5px 50px;float: right;font-size: 16px;">Welcome &nbsp; <div class="btn-group pull-right">
                          ...
                          <div class="row">
                            <div class="form-group">
                              <div class="modal-footer">
                                <input type="submit" id="submit" name="submit" value="Add" class="add_btn" style="" />
          ...
          <div class="row">
           ...
           FROM expense_tbl i, expense_category_tbl s  WHERE (i.expense_category_id = s.expense_category_id) group by i.expense_category_id");
                  ...
                  <button class="shadow_btn" data-toggle="modal" data-target="#myModal">
                    <i class="fa fa-plus-circle fa-2x"></i><span id="EE_text"> Enter Expenses</span>
                  </button>
                </div>
              </div>
              <!--End Advanced Tables -->
